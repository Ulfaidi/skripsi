    ...
    public function store(Request $request)
    {
        try {
            ...
            $request->validate([
                ...
                'kecamatan_satu_kode' => 'required|string|max:255|',
                'kecamatan_dua_kode' => 'required|string|max:255|', 
                'desa_satu_kode' => 'required|string|max:255|',
                'desa_dua_kode' => 'required|string|max:255|',
